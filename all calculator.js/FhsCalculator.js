...
function proceed4(event){
	...
	if(exit == true){
	  ...
	  if(no1.no_of_children == 0){
		...
		if(no1.childName == "" || !Age.test(no1.childName)){
		...
		if(no1.childName == "" || !Age.test(no1.childName) || no1.childName2 == "" || !Age.test(no1.childName2)){
			$m.alert("Please enter the valid age");
		}
		else{
			Calculation.fhsCalculate1(event);
		...
		if(no1.childName == "" || !Age.test(no1.childName) || no1.childName2 == "" || !Age.test(no1.childName2) || no1.childName3 == "" || !Age.test(no1.childName3)){
			$m.alert("Please enter the valid age");
	}
		else{
			Calculation.fhsCalculate1(event);
		...
		if(no1.childName == "" || !Age.test(no1.childName) || no1.childName2 == "" || !Age.test(no1.childName2) || no1.childName3 == "" || !Age.test(no1.childName3) || no1.childName4 == "" || !Age.test(no1.childName4)){
			$m.alert("Please enter the valid age");
	}
	else{
			Calculation.fhsCalculate1(event);
		...
		if(no1.childName == "" || !Age.test(no1.childName) || no1.childName2 == "" || !Age.test(no1.childName2) || no1.childName3 == "" || !Age.test(no1.childName3) || no1.childName4 == "" || !Age.test(no1.childName4) || no1.childName5 == "" || !Age.test(no1.childName5)){
			$m.alert("Please enter the valid age");
	}
	else{
			Calculation.fhsCalculate1(event);
